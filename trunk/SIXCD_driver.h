...
// A value used to perform more precise calculations without the use of
// floating-point math
...
/*!
The number of semiaxes
The standard XBox gamepad has 24 semiaxes
*/
#define NR_SEMIAXES 24
...
#define SIXCD_SIGNATURE 0x58425355l //(XBSU)
...
{
	UCHAR id;			//Report ID
	ULONG Signature;	//Should be SIXCD_SIGNATURE when data is received
	UCHAR Major;
	UCHAR Minor;
	UCHAR Release;
...
In here is all kind of data used for SIXCD. This kind of makes storing and
